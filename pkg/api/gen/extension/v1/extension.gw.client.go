...
func (c *extensionServiceGatewayClient) ListFreightHistory(ctx context.Context, req *ListFreightHistoryRequest) (*ListFreightHistoryResponse, error) {
	gwReq := c.gwc.NewRequest("POST", "/ext-api/v1/kargo/extensions/freight-history")
	gwReq.SetBody(req)
	return gateway.DoRequest[ListFreightHistoryResponse](ctx, gwReq)
}
