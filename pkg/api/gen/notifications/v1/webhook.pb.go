...
const (
	...
	WebhookEventType_WEBHOOK_EVENT_TYPE_PING        WebhookEventType = 1
	WebhookEventType_WEBHOOK_EVENT_TYPE_AUDIT       WebhookEventType = 2
	WebhookEventType_WEBHOOK_EVENT_TYPE_USAGE       WebhookEventType = 3
)
...
type WebhookEventPayload struct {
	...
	EventType      WebhookEventType       `protobuf:"varint,2,opt,name=event_type,json=eventType,proto3,enum=akuity.notifications.webhook.v1.WebhookEventType" json:"event_type,omitempty"`
...
type WebhookEventPayload_PingEvent struct {
	PingEvent *PingEvent `protobuf:"bytes,5,opt,name=ping_event,json=pingEvent,proto3,oneof"`
}

type WebhookEventPayload_UsageEvent struct {
	UsageEvent *UsageUpdateEvent `protobuf:"bytes,6,opt,name=usage_event,json=usageEvent,proto3,oneof"`
}
...
type UsageUpdateEvent struct {
	...
	UsageThreshold float64 `protobuf:"fixed64,3,opt,name=usage_threshold,json=usageThreshold,proto3" json:"usage_threshold,omitempty"`
...
// taken from akuity.organization.v1.AuditLog
type AuditEvent struct {
	...
	Actor     *AuditEvent_EventAuditActor   `protobuf:"bytes,3,opt,name=actor,proto3" json:"actor,omitempty"`
	Object    *AuditEvent_EventAuditObject  `protobuf:"bytes,4,opt,name=object,proto3" json:"object,omitempty"`
	Details   *AuditEvent_EventAuditDetails `protobuf:"bytes,5,opt,name=details,proto3" json:"details,omitempty"`
}
...
type AuditEvent_EventAuditObject struct {
	...
	Type     string                                          `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	Id       *AuditEvent_EventAuditObject_EventAuditObjId    `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	ParentId *AuditEvent_EventAuditObject_EventAuditParentId `protobuf:"bytes,3,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`
}
...
var file_notifications_v1_webhook_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x22, 0x9d, 0x07, 0x0a, 0x0a, 0x41, 0x75, 0x64, 0x69,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x1a, 0x35,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x1a, 0xb9, 0x03, 0x0a, 0x10, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41,
	0x75, 0x64, 0x69, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x5c,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4c, 0x2e, 0x61, 0x6b, 0x75,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x1a, 0x74, 0x0a, 0x12, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49,
	...
	0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63,
	...
	0x65, 0x1a, 0x64, 0x0a, 0x11, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x74, 0x63, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x70, 0x61, 0x74, 0x63, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x2a, 0x8f, 0x01, 0x0a, 0x10, 0x57, 0x65, 0x62, 0x68,
	...
	0x12, 0x1b, 0x0a, 0x17, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x45, 0x56, 0x45, 0x4e,
	0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x50, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x1c, 0x0a,
	0x18, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54,
	0x59, 0x50, 0x45, 0x5f, 0x41, 0x55, 0x44, 0x49, 0x54, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x18, 0x57,
	0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x55, 0x53, 0x41, 0x47, 0x45, 0x10, 0x03, 0x42, 0x9e, 0x02, 0x0a, 0x23, 0x63, 0x6f,
